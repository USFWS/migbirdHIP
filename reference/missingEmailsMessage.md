# Return message if all emails are missing or are exactly the same in a file with more than 10 registrations

The internal `missingEmailsMessage` function is used inside of

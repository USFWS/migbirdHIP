...
#'   \item{hunt_mig_birds}{Code to indicate if hunter hunted migratory birds last season}
...
#'   \item{rails_gallinules}{Code to indicate rail and gallinule harvest from last season}
#'   \item{cranes}{Code to indicate crane harvest from last season}
#'   \item{band_tailed_pigeon}{Code to indicate band-tailed pigeon harvest from last season}
...
#'   \item{registration_yr}{Beginning year of the hunting season that HIP registration is valid for}
...
#'
#' Tiny fake HIP data generated by \code{data-raw/create_fake_HIP_data.R} and processed by \code{\link{clean}}
#'
#' @inheritSection DF_TEST_MINI Fields
...
#'
#' Tiny fake HIP data generated by \code{data-raw/create_fake_HIP_data.R} and processed by \code{\link{issueCheck}}
#'
#' @inheritSection DF_TEST_MINI Fields
...
#'
#' Tiny fake HIP data generated by \code{data-raw/create_fake_HIP_data.R} and processed by \code{\link{duplicateFix}}
#'
#' @inheritSection DF_TEST_MINI Fields
...
#'
#' Tiny fake HIP data generated by \code{data-raw/create_fake_HIP_data.R} and processed by \code{\link{proof}}
#'
#' @inheritSection DF_TEST_MINI Fields
...
#'
#' Tiny fake HIP data generated by \code{data-raw/create_fake_HIP_data.R} and processed by \code{\link{correct}}
#'
#' @inheritSection DF_TEST_MINI Fields
#' @inheritSection DF_TEST_TINI_DEDUPED Fields added by duplicateFix

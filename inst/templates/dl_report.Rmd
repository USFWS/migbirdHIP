...
All records from this download with missing PII.

```{r pii_recs, echo = FALSE}
DT::datatable(
  record_check %>% 
    select(source_file, firstname, lastname, birth_date, address, city, state, zip))
...
Check to see which records have reported zip codes that do not belong to the state of residence.

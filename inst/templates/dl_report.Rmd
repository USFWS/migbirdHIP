...
The following records are missing first name, last name, date of birth, OR address AND email, OR city, zip AND email. They are not included in the final output table.

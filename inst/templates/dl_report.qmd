  ...
  DT::datatable(
    ...
    options =
      list(
        ...
        buttons = c("csv", "excel", "pdf"),
        columnDefs = 
          list(list(className = 'dt-body-right', targets = 5)))
    )
} else {
...
if (bad_issue_nrow > 0) {
  ...
  DT::datatable(
    ...
    options = 
      list(
        columnDefs = 
          list(list(className = 'dt-body-right', targets = 4)))
  )
}
...
if (nrow(dplyr::filter(issue_assignments, decision == "future")) > 0) {
  DT::datatable(
    ...
    options = 
      list(
        columnDefs = 
          list(list(className = 'dt-body-right', targets = 3)))
    )
} else {
...
DT::datatable(
  ...
  options = 
    list(
      columnDefs = 
        list(list(className = 'dt-body-right', targets = 2)))
  )
```

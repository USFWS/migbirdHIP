...
important_statistics <- 
  dplyr::bind_rows(
    ...
    dplyr::filter(
      !stringr::str_detect(
        value, 
        "reg_yr_eval|Current registrations with|are blank|ID fields|provided state|write-out|past records|0 future|issue_date in the|Mississippi|100% of emails|00/00/0000|2s converted")
    ) |> 
    dplyr::mutate(
      value = 
...
if(!is.null(stratacheck_tbl)) {
  ...
  kableExtra::kbl(
    ...
    kableExtra::row_spec(
      1:nrow(stratacheck_tbl), extra_css = "padding: 3px;")

...
if (!is.null(rfstate)) {
  cat(
    paste(
      "Values in the table below are reported at the field level (14 fields",
      "per record).")
  )
  kableExtra::kbl(
    rfstate |>
...
The figure below shows all issue dates received per state that are used in the final data. The red lines delineate the download period that spans the last 2 weeks from today.

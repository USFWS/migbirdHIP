...
pmts <-
  ...
  dplyr::mutate(
    ...
    record_type =
      ifelse(
        other_sum == 0 & special_sum > 0 & dl_state %in% unique(migbirdHIP:::REF_PMT_INLINE$dl_state),
        "PMT",
        NA)) |>
...
# States that have overlapping HIP issue windows are categorized as "2 season" states
states_twoseason <-

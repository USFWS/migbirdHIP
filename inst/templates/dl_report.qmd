...
dl_data <- 
  catch_messages(migbirdHIP::read_hip(params$comp_path)) |> 
...
blanks <-
  tibble::tibble(
    list.files(
      params$comp_path, recursive = F, pattern = "*\\.txt$", 
...
bullets <- 
  c(
    ...
    paste0(
      "* This cycle, ", 
      suppressWarnings(migbirdHIP::sumLines(params$comp_path)), 
...
files_received <- 
  ...
  list.files(
    stringr::str_remove(params$comp_path, "\\/D.+"), recursive = T) |> 
  tibble::as_tibble() |> 

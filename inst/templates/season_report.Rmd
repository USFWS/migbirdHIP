...
Below is a figure showing the total of number of partial duplicates in the corrected data.
...
DT::datatable(migbirdHIP::validate(corrected_data, type = "vertical", period = "dl_cycle"))
```

...
For a detailed how-to guide on using this package, please read the vignette titled *The migbirdHarvestData Workflow*. Once the migbirdHarvestData package is installed, you can view it by running:

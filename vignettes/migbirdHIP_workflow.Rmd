...
```
## * 709 future records have been modified to have registration_yr - 1. They have been copied and saved for next season in the future data .csv with their original registration_yr.
```
...
## 2 nochange    current          nochange  3203
## 3 nochange    past             bad      30023
## 4 nochange    two season state nochange  8452
## 5 postpone    past             bad       6616
```
...
##    <chr>          <chr>              <chr>            <int> <chr>  
##  1 IA20211215.txt brant              woodcock_bag      3175 0, 1, 2
##  2 IA20211215.txt brant              rails_gallinules  3175 0, 1, 2
##  3 IA20211215.txt rails_gallinules   woodcock_bag      3175 0, 1, 2
##  4 KY20211228.txt band_tailed_pigeon cranes             984 1      
##  5 KY20211228.txt band_tailed_pigeon brant              984 1      
##  6 KY20211228.txt band_tailed_pigeon seaducks           984 1      
##  7 KY20211228.txt brant              cranes             984 1      
##  8 KY20211228.txt brant              seaducks           984 1      
##  9 KY20211228.txt cranes             seaducks           984 1      
## 10 NE20211217.txt band_tailed_pigeon brant              903 1      
## # ℹ 11 more rows
```
...
##  7 ID20211229.txt 1        1764    2588       0.682
...
##   <chr>           <int>         <dbl>      <dbl> <chr>       
## 1 CT                252          3220     0.0726 error > 0.03
...
##   <chr>                  <int>         <int>      <dbl> <chr>       
## 1 registration_yr         6592         41863     0.136  error > 0.01
## 2 birth_date              1307         47148     0.0270 error > 0.01
```

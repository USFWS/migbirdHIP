...
##  7 OR       seaducks           0            1, 2         
##  8 AK       band_tailed_pigeon 0            <NA>         
##  9 AK       dove_bag           0            <NA>         
## 10 AK       rails_gallinules   0            <NA>         
## # ... with 111 more rows
```
...
##  7 WA20211229.txt 1         816    1460       0.559
...
```
## Are you sure you entered all of the parameters correctly?
```
...
```r
write_hip(DL1301_corrected, path = "C:/HIP/all_2019")
```
...
## 2 IA               2988         76387     0.0376 error > 0.03
```
...
##   <chr>             <int>         <int>      <dbl> <chr>       
## 1 ducks_bag          2937         45522     0.0606 error > 0.01
## 2 birth_date         2348         46111     0.0485 error > 0.01
```

...
```
## 49000 records from two-season states have been modified to have registration_yr - 1. They will be copied for next season with their original registration_yr.
```
...
##   <chr>           <int>         <int>      <dbl> <chr>       
## 1 CT                260          6015     0.0414 error > 0.03
```
...
##   <chr>             <int>         <int>      <dbl> <chr>       
## 1 birth_date         2348         46111     0.0485 error > 0.01
```

...
During pre-processing, R may throw an error like "invalid UTF-8 byte sequence detected". The error usually includes a field name but no other helpful information. The `glyphFinder` function identifies values containing non-UTF-8 glyphs/characters and returns them with the source file so they can be edited.


```r
glyphFinder(DL1301, email)
```
...
##  7 ID20211229.txt 1        1759    2588       0.680
...
```
##  [1] "MD"  "ESQ" "MAL" "MR"  "W"   "CJS" "CME" "M"   "SMI" "I�M"
## [11] "MO"  "MS"  "MRS" "-"
```
...
##   <chr>                  <int>         <int>      <dbl> <chr>     
## 1 registration_yr         6592         41863     0.136  error > 0…
## 2 birth_date              1307         47148     0.0270 error > 0…
```

...
## 3 nochange    past             bad      30022
## 4 nochange    two season state nochange  8452
## 5 postpone    past             bad       6615
```
...
## 2 LA               1810         43190     0.0402 error > 0.03
## 3 AL               4815        114935     0.0402 error > 0.03
```
...
## 2 birth_date              1307         47146     0.0270 error > 0.01
```

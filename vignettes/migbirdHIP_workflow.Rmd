...
## ℹ The deprecated feature was likely used in the migbirdHIP package.
...
##    <chr>    <chr>        <chr>        <chr>        
##  1 FL       dove_bag     0            1, 2, 3, 5   
##  2 IA       dove_bag     0            1, 2, 3, 5   
##  3 OR       dove_bag     0            1, 2, 3, 5   
##  4 TN       dove_bag     0            1, 2, 3, 5   
##  5 TN       woodcock_bag 0            1, 2, 3, 5   
##  6 IA       ducks_bag    0            1, 2, 3, 4   
##  7 IA       geese_bag    0            1, 2, 3, 4   
##  8 OR       ducks_bag    0            1, 2, 3, 4   
##  9 OR       geese_bag    0            1, 2, 3, 4   
## 10 TN       ducks_bag    0            1, 2, 3, 4   
## # ℹ 25 more rows
```
...
##  7 ID20211229.txt 1        1761    2588       0.680
...
## 3 LA20211220.txt  1192     1
## # A tibble: 56 × 3
##    source_file    state bad_zip
##    <chr>          <chr>   <int>
##  1 MO20211229.txt MO         36
##  2 NE20211217.txt NE         14
##  3 NE20211222.txt NE          6
##  4 AL20211229.txt AL          5
##  5 LA20211217.txt LA          5
##  6 GA20211229.txt GA          3
##  7 IA20211215.txt IA          3
##  8 UT20211229.txt UT          3
##  9 AL20211229.txt NC          2
## 10 FL20211229.txt GA          2
## # ℹ 46 more rows
```
...
```
## Error in pullErrors(DL1301_proofed, error = "suffix"): unused argument (error = "suffix")
```
...
```
## Error in pullErrors(DL1301_proofed, error = "dove_bag"): unused argument (error = "dove_bag")
```
...
##   <chr>           <int>         <int>      <dbl> <chr>       
## 1 CT                252          5948     0.0406 error > 0.03
## 2 AL               4818        114957     0.0402 error > 0.03
## 3 LA               1810         43190     0.0402 error > 0.03
```

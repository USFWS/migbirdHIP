...
```r
DL1301_current <- issueCheck(DL1301_clean, year = 2021, plot = T)
```
...
```
## Error in mutate(x, across(all_of(ref_bagfields), ~as.numeric(.x)), other_sum = rowSums(across(matches("bag|coots|rails")), : object 'DL1301_current' not found
```
...
```
## Error in group_by(x, firstname, lastname, state, birth_date, dl_state, : object 'DL1301_current' not found
```
...
```
## Error in select(x, dl_state, all_of(ref_bagfields)): object 'DL1301_fixed' not found
```
...
```
## Error in group_by(x, source_file): object 'DL1301_fixed' not found
```
...
```
## Error in select(x, source_file, ducks_bag, geese_bag, coots_snipe): object 'DL1301_fixed' not found
```
...
```
## Error in mutate(DL1301_fixed, ducks_bag = ifelse(dl_state == "AK", 3, : object 'DL1301_fixed' not found
```
...
```
## Error in select(x, dl_state, dl_date, ducks_bag): object 'DL1301_fixed' not found
```
...
```
## Error in mutate(x, temp_key = paste0("row_", row_number())): object 'DL1301_fixed' not found
```
...
```
## Error in mutate(x, errors = ifelse(is.na(errors), "none", errors), title = ifelse(str_detect(errors, : object 'DL1301_proofed' not found
```
...
```
## Error in pullErrors(DL1301_proofed, field = "suffix"): object 'DL1301_proofed' not found
```
...
```
## Error in pullErrors(DL1301_proofed, field = "dove_bag"): object 'DL1301_proofed' not found
```
...
```
## Error in select(x, state, dl_state): object 'DL1301_proofed' not found
```
...
```
## Error in group_by(x, dl_state): object 'DL1301_proofed' not found
```
...
```
## Error in unique(x$dl_state): object 'DL1301_proofed' not found
```
...
```
## Error in select(x, errors, dl_state): object 'DL1301_proofed' not found
```
...
```
## Error in errorTable(DL1301_proofed): object 'DL1301_proofed' not found
```
...
```
## Error in errorTable(DL1301_proofed, field = "none"): object 'DL1301_proofed' not found
```
...
```
## Error in errorTable(DL1301_proofed, loc = "none"): object 'DL1301_proofed' not found
```
...
```
## Error in errorTable(DL1301_proofed, loc = "CA"): object 'DL1301_proofed' not found
```
...
```
## Error in errorTable(DL1301_proofed, field = "suffix"): object 'DL1301_proofed' not found
```
...
```
## Error in errorTable(DL1301_proofed, loc = "CA", field = "none"): object 'DL1301_proofed' not found
```
...
```
## Error in errorTable(DL1301_proofed, loc = "CA", field = "dove_bag"): object 'DL1301_proofed' not found
```
...
```
## Error in select(x, errors): object 'DL1301_proofed' not found
```

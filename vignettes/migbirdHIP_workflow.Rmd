...
```
## Error in library(migbirdHIP): there is no package called 'migbirdHIP'
```
...
```
## Error in read_hip("C:/HIP/DL1202"): could not find function "read_hip"
```
...
```
## Error in clean(DL1202): could not find function "clean"
```
...
```
## Error in findDuplicates(DL1202_clean): could not find function "findDuplicates"
```
...
```
## Error in findDuplicates(DL1202_clean, return = "table"): could not find function "findDuplicates"
```
...
```
## Error in fixDuplicates(DL1202_clean): could not find function "fixDuplicates"
```
...
```
## Error in strataCheck(DL1202_fixed): could not find function "strataCheck"
```
...
```
## Error in validate(DL1202_fixed, type = "horizontal"): could not find function "validate"
```
...
```
## Error in validate(DL1202_fixed, type = "vertical"): could not find function "validate"
```
...
```
## Error in validate(DL1202_fixed, type = "vertical", period = "dl_cycle"): could not find function "validate"
```
...
```
## Error in investigate(DL1202_fixed, loc = "AK", period_type = "dl_date", : could not find function "investigate"
```
...
```
## Error in proof(DL1202_fixed, year = 2020): could not find function "proof"
```
...
```
## Error in correct(DL1202_proofed, year = 2020, data = "bag"): could not find function "correct"
```
...
```
## Error in outOfStateHunters(DL1202_proofed): could not find function "outOfStateHunters"
```
...
```
## Error in errorPlot_fields(DL1202_proofed, loc = "all", year = 2020): could not find function "errorPlot_fields"
```
...
```
## Error in errorPlot_fields(DL1202_proofed, loc = "LA", year = 2020): could not find function "errorPlot_fields"
```
...
```
## Error in errorPlot_fields(DL1202_proofed, year = 2020, youth = TRUE): could not find function "errorPlot_fields"
```
...
```
## Error in errorPlot_states(DL1202_proofed): could not find function "errorPlot_states"
```
...
```
## Error in errorTable(DL1202_proofed, loc = "CA", field = "dove_bag"): could not find function "errorTable"
```

...
![plot of chunk errorfieldsplotall](figure/errorfieldsplotall-1.png)
...
![plot of chunk errorfieldsplotsc](figure/errorfieldsplotsc-1.png)
...
![plot of chunk errorfieldsplotyouth](figure/errorfieldsplotyouth-1.png)
...
![plot of chunk errorstatesprop](figure/errorstatesprop-1.png)
...
![plot of chunk errorstatescount](figure/errorstatescount-1.png)
...
![plot of chunk findDuplicates](figure/findDuplicates-1.png)
...
![plot of chunk outofstatect](figure/outofstatect-1.png)
...
![plot of chunk outofstatepr](figure/outofstatepr-1.png)
...
![plot of chunk youth](figure/youth-1.png)
...
The `writeReport` function can be used to automatically generate an R markdown document with figures, tables, and summary statistics. This can be done at the end of a download cycle (using `type = "dl_report"`) or the entire HIP season (with `type = "season_report"`). You should expect `writeReport` to run for ~1 minute for a download cycle, or ~30 minutes for a total season (containing approximately 4 million records). Writing a total season report is a memory intensive process, so for this option, we recommend increasing your memory allocated to R (shown below).

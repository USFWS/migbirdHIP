...
- [Stage 2: Explore Errors](#stage-2-explore-errors)
    - [proof](#proof)
    - [errorTable](#errortable)
    - [pullErrors](#pullerrors)
    - [redFlags](#redflags)
- [Stage 3: Visualize Data](#stage-3-visualize-data)
...
##  4 OR       band_tail~ 0            1, 2          
##  5 OR       brant      0            1, 2          
##  6 OR       seaducks   0            1, 2          
##  7 MO       dove_bag   9            0, 1, 2, 3, 5 
##  8 NE       dove_bag   9            0, 1, 2, 3, 5 
##  9 MO       woodcock_~ 9            0, 1, 2, 3, 4~
## 10 NE       woodcock_~ 6            0, 1, 2, 3, 4~
## # ... with 275 more rows
```
...
Tibbles of vertical repetition returned from this function can be looked at more closely using `investigate`.

### investigate

Did the `validate` function return repeated values? Are some of those values a high number that are uniform and need to be looked at more closely? The `investigate` function allows you to see what value was vertically repeated for a species. Parameters required are download state, type of download time period, value of the download date or download cycle, and species, which are all provided in the output of `validate`.
...
```
## # A tibble: 2 x 5
##   dl_state count_errors count_correct proportion
##   <chr>           <int>         <int>      <dbl>
## 1 CT                120          2730     0.0421
## 2 IA               3221         77679     0.0398
## # ... with 1 more variable: flag <chr>
```
...
```
## # A tibble: 4 x 5
##   errors count_errors count_correct proportion
##   <chr>         <int>         <int>      <dbl>
## 1 birth~         5646         87525     0.0606
## 2 email          5496         87675     0.0590
## 3 ducks~         3113         90058     0.0334
## 4 zip            2132         91039     0.0229
## # ... with 1 more variable: flag <chr>
```

## Stage 3: Visualize Data
...
```
## # A tibble: 3 x 4
##   dl_state registered_youth total_registered
##   <chr>               <int>            <int>
## 1 MO                      1             4047
## 2 ND                    117              175
## 3 NE                      1              549
## # ... with 1 more variable:
## #   youth_proportion <dbl>
```

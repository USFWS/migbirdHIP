...
The `outOfStateHunters` function allows us to visualize how many hunters reported harvests from a dl_state that does not match the state, province, or territory of their address. This function can plot errors as either proportions or counts by state.
...
* *Suffix* is changed to NA if it is not equal to:
    * JR or SR
    * A value equal to II or III
    * An ordinal value between 2ND and 9TH

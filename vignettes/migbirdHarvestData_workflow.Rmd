...
##  1 1     <NA>   G     KYI    <NA>  4427~ JACK~ FL    3220~ 10/2~ 12/0~ 2     1     0     1     2     1     1     0    
##  2 1     TYLER  W     CARY   <NA>  2595~ VENE~ <NA>  <NA>  10/2~ 12/0~ 2     1     1     1     1     1     1     0    
##  3 1     DANIEL E     BLODG~ <NA>  6707  SPOT~ <NA>  <NA>  03/2~ 12/0~ 2     1     1     1     1     1     1     0    
##  4 1     JUAN   M     ORTIZ~ <NA>  155 ~ FAYE~ <NA>  <NA>  01/0~ 12/1~ 2     1     1     1     1     1     1     0    
##  5 1     CODY   M     CORMI~ <NA>  3748~ NEW ~ <NA>  <NA>  09/1~ 12/1~ 2     1     1     1     1     1     1     0    
##  6 1     THOMAS J     BRENN~ Jr.   1520~ POMP~ <NA>  <NA>  02/1~ 12/1~ 2     1     1     1     1     1     1     0    
##  7 1     CHRIS~ <NA>  PERRO~ <NA>  4494~ LOXA~ <NA>  <NA>  06/2~ 12/1~ 2     2     2     2     2     1     1     0    
##  8 1     ANDREW C     ADAMS  <NA>  45 M~ MILAN <NA>  <NA>  09/0~ 12/1~ 2     3     2     1     1     1     1     0    
##  9 1     MASON  E     HITCH~ <NA>  BRAS~ ROCK~ <NA>  <NA>  05/3~ 12/1~ 2     1     1     1     1     1     1     0    
## 10 1     WILLIS L     MANCIL <NA>  8926~ WILL~ <NA>  <NA>  05/2~ 12/1~ 2     1     1     1     1     1     1     0    
## # ... with 93 more rows, and 9 more variables: X20 <chr>, X21 <chr>, X22 <chr>, X23 <chr>, X24 <chr>, dl_state <chr>,
## #   dl_date <chr>, source_file <chr>, dl_cycle <chr>
```
...
##  2 AL20201216.txt 1        5798    7080       0.819
##  3 MI20201216.txt 1         343     419       0.819
##  4 SC20201202.txt 1        6318    7841       0.806
##  5 MS20201215.txt 1        6708    8929       0.751
##  6 MO20201216.txt 1        2954    4047       0.730
##  7 CT20201216.txt 1          75     116       0.647
##  8 RI20201216.txt 1         101     157       0.643
##  9 OH20201216.txt 1         629    1057       0.595
## 10 MN20201216.txt 1         733    1279       0.573
## # ... with 37 more rows
```
...
##   <chr>             <int>         <int>      <dbl> <chr>       
## 1 birth_date         5637         87390     0.0606 error > 0.01
## 2 email              5495         87532     0.0591 error > 0.01
## 3 ducks_bag          3109         89918     0.0334 error > 0.01

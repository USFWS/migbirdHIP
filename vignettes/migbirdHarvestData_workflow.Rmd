...
##   <chr>                        <chr>           <dbl>
## 1 C:/HIP/DL1202/MO20201216.txt ISO-8859-1      0.27 
## 2 C:/HIP/DL1202/NE20201209.txt ISO-8859-1      0.290
## 3 C:/HIP/DL1202/NE20201209.txt ISO-8859-2      0.22 
## 4 C:/HIP/DL1202/SC20201202.txt ISO-8859-1      0.28 
## # A tibble: 104 x 5
##    dl_state X2          X4           X8    X10       
##    <chr>    <chr>       <chr>        <chr> <chr>     
##  1 AR       <NA>        <NA>         <NA>  <NA>      
##  2 FL       <NA>        KYI          FL    10/28/1990
##  3 GA       TYLER       CARY         <NA>  10/27/1985
##  4 GA       DANIEL      BLODGETT     <NA>  03/28/1955
##  5 GA       JUAN        ORTIZ-ATILES <NA>  01/04/1974
##  6 GA       CODY        CORMIER      <NA>  09/12/1997
##  7 GA       THOMAS      BRENNAN      <NA>  02/19/1992
##  8 GA       CHRISTOPHER PERRONE      <NA>  06/25/2001
##  9 GA       ANDREW      ADAMS        <NA>  09/08/2001
## 10 GA       MASON       HITCHCOCK    <NA>  05/31/2002
## # ... with 94 more rows
```
...
## 16 suffix                       1
## 17 suffix-address-email         1
## 18 suffix-issue_date            1
## 19 zip                          1
```
...
##  7 OR       seaducks           0            1, 2            
##  8 MO       dove_bag           9            0, 1, 2, 3, 5   
##  9 NE       dove_bag           9            0, 1, 2, 3, 5   
...
##  2 AL20201216.txt 1        5774    7049       0.819
##  3 MI20201216.txt 1         341     417       0.818
##  4 SC20201202.txt 1        6308    7831       0.806
##  5 MS20201215.txt 1        6706    8924       0.751
##  6 MO20201216.txt 1        2954    4047       0.730
##  7 RI20201216.txt 1         101     156       0.647
##  8 CT20201216.txt 1          73     114       0.640
##  9 OH20201216.txt 1         628    1056       0.595
## 10 MN20201216.txt 1         732    1278       0.573
## # ... with 37 more rows
```
...
## 2 IA               3216         77509     0.0398 error > 0.03
```
...
##   <chr>             <int>         <int>      <dbl> <chr>       
## 1 birth_date         5634         87361     0.0606 error > 0.01
## 2 email              5494         87501     0.0591 error > 0.01
## 3 ducks_bag          3109         89886     0.0334 error > 0.01
```

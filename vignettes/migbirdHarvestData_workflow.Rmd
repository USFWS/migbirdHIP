...
The year in which the HIP data were collected can be specified in `errorPlot_fields` to view the proportion of "errors" created by youth hunters. Youth hunters are not included in the error plot if `specify` is not defined.

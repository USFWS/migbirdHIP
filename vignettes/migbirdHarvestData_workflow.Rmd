...
```
## Error in library(migbirdHarvestData): there is no package called 'migbirdHarvestData'
```
...
```
## Error in compile(path = "C:/HIP/DL_1202"): could not find function "compile"
```
...
```
## Error in compile_to_utf8(path = "C:/HIP/DL_1202"): could not find function "compile_to_utf8"
```
...
```
## Error in tidy(DL1202_utf8): could not find function "tidy"
```
...
```
## Error in validate(DL1202_tidied): could not find function "validate"
```
...
```
## Error in proof(DL1202_tidied, year = 2020): could not find function "proof"
```
...
```
## Error in errorPlot_fields(DL1202_proofed, loc = "all"): could not find function "errorPlot_fields"
```
...
```
## Error in errorPlot_fields(DL1202_proofed, loc = "SC"): could not find function "errorPlot_fields"
```
...
```
## Error in errorPlot_fields(DL1202_proofed, specify = 2020): could not find function "errorPlot_fields"
```
...
```
## Error in errorPlot_states(DL1202_proofed, type = "proportion"): could not find function "errorPlot_states"
```
...
```
## Error in errorPlot_states(DL1202_proofed, type = "count"): could not find function "errorPlot_states"
```
...
```
## Error in findDuplicates(DL1202_proofed): could not find function "findDuplicates"
```
...
```
## Error in outOfStateHunters(DL1202_proofed, type = "count"): could not find function "outOfStateHunters"
```
...
```
## Error in outOfStateHunters(DL1202_proofed, type = "proportion"): could not find function "outOfStateHunters"
```
...
```
## Error in youthHunters(DL1202_proofed, year = 2020): could not find function "youthHunters"
```
...
```
## Error in investigate(DL1202_tidied, loc = "TX", date = "20201216", species = "cranes"): could not find function "investigate"
```
...
```
## Error in errorTable(DL1202_proofed): could not find function "errorTable"
```
...
```
## Error in errorTable(DL1202_proofed, field = "none"): could not find function "errorTable"
```
...
```
## Error in errorTable(DL1202_proofed, loc = "none"): could not find function "errorTable"
```
...
```
## Error in errorTable(DL1202_proofed, loc = "CA"): could not find function "errorTable"
```
...
```
## Error in errorTable(DL1202_proofed, field = "suffix"): could not find function "errorTable"
```
...
```
## Error in errorTable(DL1202_proofed, loc = "CA", field = "none"): could not find function "errorTable"
```
...
```
## Error in errorTable(DL1202_proofed, loc = "CA", field = "zip"): could not find function "errorTable"
```
...
```
## Error in pullErrors(DL1202_proofed, error = "dove_bag"): could not find function "pullErrors"
```
...
```
## Error in redFlags(DL1202_proofed, type = "state", threshold = 0.03): could not find function "redFlags"
```
...
```
## Error in redFlags(DL1202_proofed, type = "field", threshold = 0.01): could not find function "redFlags"
```
...
```
## Error in correct(DL1202_proofed, year = 2020): could not find function "correct"
```

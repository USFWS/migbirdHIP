...
<img src="man/figures/migbirdHIP_flowchart.svg" alt="Overview of migbirdHIP functions in a flowchart format." width="100%" />
...
#>   <chr>          <chr>       <chr>     <chr>   
#> 1 KY20240906.txt record_3516 TEST      TEST
#> Error: One or more records has a '0' in every bag field; these records will be filtered out in clean().
#> # A tibble: 9 × 2
#>   source_file    record_key  
#>   <chr>          <chr>       
#> 1 CO20240905.txt record_1194 
#> 2 KS20240830.txt record_3229 
#> 3 NV20240810.txt record_7176 
#> 4 OK20240822.txt record_7848 
#> 5 OR20240828.txt record_8037 
#> 6 OR20240828.txt record_8078 
#> 7 TN20240822.txt record_9076 
#> 8 WA20240818.txt record_10234
#> 9 WA20240818.txt record_10286
```
...
#> There are 36 registrations with duplicates; 72 total duplicated records.
#> # A tibble: 2 × 2
#>   duplicate_field     n
#>   <chr>           <int>
#> 1 bag                13
...
#>  2 DE       woodcock_bag     9             1, 2, 3, 5             1 0%        
#>  3 MO       dove_bag         9             1, 2, 3, 5             1 0%        
#>  4 MS       dove_bag         9             1, 2, 3, 5             1 0%        
#>  5 NJ       woodcock_bag     9             1, 2, 3, 5             1 0%        
#>  6 OH       dove_bag         9             1, 2, 3, 5             1 0%        
#>  7 SC       rails_gallinules 9             1, 2, 3, 5             1 0%        
#>  8 SC       woodcock_bag     9             1, 2, 3, 5             1 0%        
#>  9 UT       dove_bag         9             1, 2, 3, 5             1 0%        
#> 10 VA       dove_bag         9             1, 2, 3, 5             1 0%        
#> # ℹ 86 more rows
```
...
-   `title` should be one of: NA, 0, 1, 2
...
-   `state` is flagged if it is not contained in the following list of abbreviations for US and Canada states, provinces, and territories:
    -   AL, AK, AZ, AR, CA, CO, CT, DE, FL, GA, HI, ID, IL, IN, IA, KS, KY, LA, ME, MD, MA, MI, MN, MS, MO, MT, NE, NV, NH, NJ, NM, NY, NC, ND, OH, OK, OR, PA, RI, SC, SD, TN, TX, UT, VT, VA, WA, WV, WI, WY, DC, AS, GU, MP, PR, VI, UM, MH, FM, PW, AA, AE, AP, AB, BC, MB, NB, NL, NS, NT, NU, ON, PE, PQ, QC, SK, YT
